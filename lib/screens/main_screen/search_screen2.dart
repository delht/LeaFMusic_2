...
import 'package:leafmusic_2/widgets/search/genre_list_search.dart';
...
class SearchScreen2 extends StatefulWidget {
  @override
  _SearchScreenState2 createState() => _SearchScreenState2();
}

class _SearchScreenState2 extends State<SearchScreen2> {
          ...
          children: [
            ...
            Padding(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  ...
                  suffixIcon: IconButton(
                    ...
                    onPressed: () {
                      context
                          .read<SearchBloc>()
                          .add(LoadSearch2(keyword: _searchController.text));
                    },
                ...
                onChanged: (query) {
                  context.read<SearchBloc>().add(LoadSearch2(keyword: query));
                },
